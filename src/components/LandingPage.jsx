...
function LandingPage() {
   ...
   return (
      <div className='relative min-h-screen overflow-hidden'>
         ...
         {/* </div> */}
         {/* Content layer */}{' '}
         <div className='relative z-10 min-h-screen flex flex-col bg-gradient-to-br from-indigo-700/95 via-purple-700/95 to-blue-700/95 dark:from-indigo-900/95 dark:via-purple-900/95 dark:to-blue-900/95 backdrop-blur-sm'>
                  ...
                  >
                     ...
                     <div className='mt-12 space-y-6'>
                        ...
                        <div className='flex justify-center'>
                           {' '}
                           <div className='bg-indigo-300/10 backdrop-blur-sm px-4 py-2 rounded-full border border-indigo-300/20'>
